...
<head>
    ...
    <link rel="shortcut icon"
        href="https://res.cloudinary.com/dwipjtlpj/image/upload/v1691811015/setecloud/10_xpwlsu.png">
    ...
    <div class="container pt-md-14 pb-md-11">
        <div class="row align-items-center">
            ...
            <div class="col-lg-3 col-md-12 d-flex align-items-center justify-md-content-center">
                <img src="https://res.cloudinary.com/dwipjtlpj/image/upload/v1691800680/setecloud/multipleos_datnwk.png"
                    alt="" class="">
            </div>
        </div>
        ...
        <ul class="nav nav-tabs nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab3-3">
                    <span>Gestión asistida</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab3-4">
                    <span>Garantías y restricciones</span>
                </a>
            </li>
        </ul>
        <!-- /.nav-tabs -->
        <div class="tab-content mt-12 mt-md-10">
                ...
                <table class="table table1 table-striped">
                    <tbody>
                        <tr>
                            ...
                            <td>HP Enterprise Servers Gen9 / Gen10</td>
                        </tr>
                        <tr class="second-column">
                            <td>Procesadores</td>
                            <td>Intel Xeon™ de última generación</td>
                        </tr>
                        <tr class="second-column">
                            <td>Almacenamiento</td>
                            <td>CEPH (Distribuido y Redundante)</td>
                        </tr>
                        <tr class="second-column">
                            <td>Red local</td>
                            <td>Red Privada 10GE</td>
                        </tr>
                        <tr class="second-column">
                            <td>Arquitectura</td>
                            <td>x64 (64 bits)</td>
                        ...
                        <tr class="second-column">
                            <td>Nivel Acceso</td>
                            <td>Root SSH - Linux / Administrador RDP - Windows</td>
                        </tr>
                        <tr class="second-column">
                            <td>Consola de gestión</td>
                            <td>Monitoreo y métricas de recursos</td>
                        </tr>
                        <tr class="second-column">
                            <td>Equipamiento de Red</td>
                            <td>Cisco™</td>
                        </tr>
                        <tr class="second-column">
                        ...
                        <tr class="second-column">
                            <td>Soporte</td>
                            <td>- Correo-e (24x7)
                                - Teléfono y chat (horario oficina)</td>
                        </tr>
                        <tr class="second-column">
                            <td>Distribuciones Soportadas
                                Linux</td>
                            <td> CentOS (64-bit)
                                - Red Hat Enterprise Linux (64-bit)
                                - Ubuntu LTS (64-bit)
                                - Fedora Server (64-bit)
                                - Debian (64-bit)</td>
                        </tr>
                        <tr class="second-column">
                            <td>Versiones soportadas
                                Windows</td>
                            <td> - Microsoft Windows Server 2012 R2 Std (64-bit)
                                - Microsoft Windows Server 2016 Core Std (64-bit)
                                - Microsoft Windows Server 2019 Core Std (64-bit)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <div class="tableWrapper" style="margin-top:15px;">
                    <table cellspacing="0" cellpadding="0" class="table table-bordered">
                        <tr class="alternate">
                            ...
                            <th class="textCenter" width="38%">GESTION ASISTIDA</th>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Costo mensual</strong></th>
                            <td class="textCenter"><strong>S/. 0.00</strong></td>
                            <td class="textCenter"><strong>S/. 60.00 x mes</strong></td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Configuración inicial</strong></th>
                            <td class="textCenter">Si</td>
                            <td class="textCenter">Si</td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Instalación / Configuración de Servicios</strong></th>
                            <td class="textCenter unavailable"></td>
                            <td class="textCenter">Si</td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Soporte a plataforma base</strong></th>
                            <td class="textCenter unavailable"></td>
                            <td class="textCenter">Linux (SO, Apache, Exim, MySQL) <br> Windows (SO, IIS, SQLServer)
                            </td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Sistema Operativo</strong></th>
                            <td class="textCenter">A elección</td>
                            <td class="textCenter">CentOS / RedHat / Windows</td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Reinicio remoto</strong></th>
                            <td class="textCenter">Si</td>
                            <td class="textCenter">Si</td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Reinstalación de SO</strong></th>
                            <td class="textCenter">según <a href="https://www.hostinglabs.pe/legal/fee">tarifario</a>
                            </td>
                            <td class="textCenter">Si</td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Actualización de SO</strong></th>
                            <td class="textCenter">según <a href="https://www.hostinglabs.pe/legal/fee">tarifario</a>
                            </td>
                            <td class="textCenter">Si</td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Inspección de Logs</strong></th>
                            <td class="textCenter">según <a href="https://www.hostinglabs.pe/legal/fee">tarifario</a>
                            </td>
                            <td class="textCenter">Si</td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Monitoreo de red (conectividad)</strong></th>
                            <td class="textCenter">Si</td>
                            <td class="textCenter">Si</td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Monitoreo a puertos de servicio</strong></th>
                            <td class="textCenter unavailable"></td>
                            <td class="textCenter">Pulsos cada minuto.<br>Respuesta proactiva ante fallas.</td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Backups remotos</strong></th>
                            <td class="textCenter unavailable"></td>
                            <td class="textCenter"><strong>Configuración</strong> en frecuencia y retenciones</td>
                        </tr>
                        <tr>
                            <th class="valor"><strong>Soporte</strong></th>
                            <td class="textCenter">Correo-e (24x7)<br />Teléfono y chat (horario oficina)</td>
                            <td class="textCenter">Correo-e (24x7)<br />Teléfono y chat (horario oficina)</td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="tab-pane fade" id="tab3-4">
                <div class="row">
                    <div class="col-md-6">
                        <h4><span>Nuestras</span> Garantías</h4>
                        <p class="text">Todos nuestros servidores dedicados están cubiertos por nuestro SLA. Este
                            incluye:</p>
                        <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                            <li><i class="uil uil-check"></i>Uptime garantizado de 99.99% en conectividad (Red) y
                                suministro eléctrico.</li>
                            <li><i class="uil uil-check"></i>Recursos garantizados (CPU, RAM &amp; BW) en cada servidor
                                contratado.</li>
                            <li><i class="uil uil-check"></i>Protección basica contra ataques DDOS de hasta 1Gbps.</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <h4>Restricciones <span>Generales</span></h4>
                        <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                            <li><i class="uil uil-check"></i>Alojar material audiovisual sin contar con derechos de
                                autor.</li>
                            <li><i class="uil uil-check"></i>Alojar malware, sitios de phishing y otros que intenten
                                infringir daño a terceros.</li>
                        </ul>
                    </div>
                </div>
            </div>
