        ...
        <div class="row gy-6 gy-lg-0">
            ...
            <div class="col-md-12 col-lg-2">
                <div class="widget">
                    ...
                    <ul class="list-unstyled  mb-0">
                        <li> <a href="/hosting-web" class="text-white">Certificados SSL</a></li>
                        <li> <a href="/hosting-web" class="text-white">Almacenamiento en Nube</a></li>
                        <li> <a href="/hosting-web" class="text-white">Correo Corporativo</a></li>
                    </ul>
                </div>
                <!-- /.widget -->
            </div>
